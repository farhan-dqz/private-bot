...
if (hrs >= 12 && hrs <= 17) wish = 'Wishing you a Healthy & Happy Fabulous Noon! Good Afternoon 🌞', wishml = 'നിങ്ങൾക്ക് ആരോഗ്യകരവും സന്തോഷകരവുമായ അതിശയകരമായ ഉച്ചഭക്ഷണം ആശംസിക്കുന്നു! ഗുഡ് ആഫ്റ്റർനൂൺ 🌞 LiyaMol', wishid - 'Semoga Anda Sehat & Selamat Siang yang Luar Biasa! Selamat siang 🌞'
if (hrs >= 17 && hrs <= 19) wish = 'May the setting sun take down all your sufferings with it and make you hopeful for a new day! Good Evening 🌥', wishml = 'അസ്തമയ സൂര്യൻ നിങ്ങളുടെ എല്ലാ കഷ്ടപ്പാടുകളും ഇല്ലാതാക്കുകയും ഒരു പുതിയ ദിവസത്തിനായി നിങ്ങളെ പ്രതീക്ഷിക്കുകയും ചെയ്യട്ടെ! ഗുഡ് ഈവനിംഗ് 🌥 LiyaMol ', wishid = 'Semoga matahari terbenam menghapus semua penderitaan Anda dengannya dan membuat Anda berharap untuk hari yang baru! Selamat malam 🌥'
if (hrs >= 19 && hrs <= 24) wish = 'Touch your heart, close your eyes, make a wish & Sleep! Good night 🌙', wishml = 'നിങ്ങളുടെ ഹൃദയത്തിൽ സ്പർശിക്കുക, കണ്ണുകൾ അടയ്ക്കുക, നിങ്ങളുടെ മനസ്സിൽ ഒരു ആഗ്രഹം പറയുകയും ഉറങ്ങുകയും ചെയ്യുക! ശുഭ രാത്രി 🌙 LiyaMol', wishid = 'Sentuh hatimu, pejamkan matamu, buat permohonan & Tidur! Selamat malam 🌙'
    ...
    Asena.addCommand({pattern: 'list ?(.*)', fromMe: td, dontAddCommandList: true}, (async (message, match) => {
        ...
        if (match[1] === '') {
            ...
            await message.client.sendMessage(
                message.jid, MSG + CMD_HELP + FMSG, MessageType.text, {contextInfo: { forwardingScore: 49, isForwarded: true }, quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(message.jid ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg", "caption": "◄━━━━━━━⦁⦁ saidali ⦁⦁━━━━━━━━►", "fileSha256": "+Ia+Dwib70Y1CWRMAP9QLJKjIJt54fKycOfB2OEZbTU=", "fileLength": "28777", "height": 1080, "width": 1079, "mediaKey": "vXmRR7ZUeDWjXy5iQk17TrowBzuwRya0errAFnXxbGc=", "fileEncSha256": "sR9D2RS5JSifw49HeBADguI23fWDz1aZu4faWG/CyRY=", "directPath": "/v/t62.7118-24/21427642_840952686474581_572788076332761430_n.enc?oh=3f57c1ba2fcab95f2c0bb475d72720ba&oe=602F3D69", "mediaKeyTimestamp": "1610993486", "jpegThumbnail": fs.readFileSync('./photo/IMG_20210706_002935.jpg')}}}});
        } else {
